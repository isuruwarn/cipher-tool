...
public class MainWindow implements ActionListener {
	...
	public MainWindow() {
		...
		encBtnGridCons.insets = new Insets(0,40,10,15);
		...
		decrBtnGridCons.insets = new Insets(0,20,10,0);
		...
		inputGridCons.gridwidth = 3;
		inputGridCons.anchor = GridBagConstraints.LINE_END;
		...
		outputGridCons.gridwidth = 3;
		outputGridCons.anchor = GridBagConstraints.LINE_END;
		...
		JMenuItem copyOutput = new JMenuItem( Constants.COPY_OUPUT_ACTION );
	...
	public void actionPerformed(ActionEvent e) {
		...
		if( command.equals(Constants.LOAD_KEY) || command.equals(Constants.LOAD_KEY_ACTION) ) {
			...
			if(keyFile == null || keyFile.equals("") ) {
				JOptionPane.showMessageDialog( mainFrame, Constants.LOAD_KEY_MESSAGE, Constants.ERROR, JOptionPane.ERROR_MESSAGE );
		...
		} else if( command.equals(Constants.COPY_OUPUT_ACTION) ) {
			output.selectAll();
			output.copy();
			...
			JOptionPane.showMessageDialog( mainFrame, Constants.INSTRUCTIONS_MESSAGE, Constants.INSTRUCTIONS, JOptionPane.INFORMATION_MESSAGE );
			
		}  else if( command.equals(Constants.ABOUT) ) {
			JOptionPane.showMessageDialog( mainFrame, Constants.ABOUT_MESSAGE, Constants.ABOUT, JOptionPane.INFORMATION_MESSAGE );
